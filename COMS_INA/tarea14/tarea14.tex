...
Los valores de $E_b/N_0$ simulados están en el rango \([0,30]\) dB.

Las curvas teóricas utilizadas como referencia corresponden a:
\[
P_b^{\text{QPSK, AWGN}} = \frac{1}{2}\,\mathrm{erfc}\!\left(\sqrt{E_b/N_0}\right),
\qquad
...
\textbf{Comentario breve:}  
A mayor número de antenas transmisoras, se aprecia una mejora significativa en la pendiente de decaimiento del BER, especialmente en 4×1 y 8×1. Esto es esperable debido a la ganancia de diversidad en el enlace ascendente. La curva 1×1 coincide con el desempeño teórico, validando la implementación.
...
\textbf{Comentario breve:}  
El desempeño mejora sustancialmente con el tamaño de la matriz MIMO. Las configuraciones 4×4 y 8×8 muestran pendientes mucho más pronunciadas debido a la diversidad espacial plena. ZF se vuelve más robusto cuando aumenta $N_r > N_t$ o cuando el canal tiene más grados de libertad.
...
\textbf{Comentario breve:}  
MMSE entrega mejoras considerables en baja SNR respecto a ZF, especialmente visibles en 1×1 y 2×1. El desempeño converge al de ZF en alta SNR, como es teóricamente esperado.
...
\begin{mdframed}
\inputminted{python}{tarea14.ipynb}
\end{mdframed}
